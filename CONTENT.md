...
- `footer-x.png`, `footer-linkedin.png`, `footer-github.png`, and `footer-email.png` contain the individual multicolor jeweled words. Each footer link owns one image and its native dimensions in `src/content/site.ts`.
- `footer-star.png` is the decorative pink jeweled separator between links.
